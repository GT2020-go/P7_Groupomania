...
import { editArticleImage } from "../../actions/articleActions";

// const articleInitialState = useSelector((state) => state.articles);

const EditArticleImage = ({ imageId }) => {
  //step1: delete current image
  //step2: post new image
  ...
  const handleSubmit = (e) => {
    ...
    console.log(toto);
    e.preventDefault();
    dispatch(editArticleImage(toto, article.id));
  };
